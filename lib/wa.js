...
exports.sendFakeStatus2 = (from, teks) => {
        leo.sendMessage(from, teks, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": 'T90 mᎾᎠs', "jpegThumbnail": fs.readFileSync(`./media/imagen/fake.jpg`)} } } })
}
