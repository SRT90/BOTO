...
const command = comm
  ...
  const ownerNumber = "34657993207@s.whatsapp.net"
  const Oowner  = "34657993207@s.whatsapp.net"
...
★·.·¯·.·★ *YOUTUBE* ★·.·¯·.·★
_https://www.youtube.com/channel/UC7GXmDFqoCjfvmNPjACF5CQ?sub_confirmation=1_

★·.·¯·.·★ *INSTAGRAM* ★·.·´¯·.·★
https://www.instagram.com/t9ma.n/

★·.·¯·.·★ *GITHUB* ★·.·¯·.·★
https://github.com/SRT90`
const quecanciones = `
...
_https://youtube.com/shorts/UUixCPCLD4U?feature=share_`
...
*Youtube:*
https://www.youtube.com/channel/UC7GXmDFqoCjfvmNPjACF5CQ?sub_confirmation=1
...
*Youtube:* youtube.com/channel/UC7GXmDFqoCjfvmNPjACF5CQ`
...
git clone https://github.com/SRT90
...
if (choute.message.buttonsResponseMessage){
  ...
  if (test.includes(`sex`)){
    ...
    mediaUrl: "https://youtube.com/shorts/UUixCPCLD4U?feature=share"}}}) 
    addFilter(from)
...
if (test.includes(`grupo`)){
  ...
  *-Te invito a unirte al grupo de WhatsApp donde:-*
  ...
  Grupo 1 : 
  _https://chat.whatsapp.com/EnF7hPPpRYoJmBsk0SuF1r_
  
  Grupo 2 : 
  _https://chat.whatsapp.com/EnF7hPPpRYoJmBsk0SuF1r_`, MessageType.text, {quoted: choute})
  addFilter(from)
    addLevelingLevel(sender, 5)	}}
...
if (choute.message.listResponseMessage){
  ...
  leo.updatePresence(from, Presence.composing)
  if (!isRegister) return reply(baby.only.usrReg)
tampa = leo.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 9999999, "message": `${reglas}`, "footerText": "*T90 mᎾᎠs*", "thumbnail": fs.readFileSync('./media/imagen/imgregla.jpg'), "surface": 'CATALOG' }}, {contextInfo: { mentionedJid: [sender,Oowner]}, quoted:choute, })
...
if (choute.message.listResponseMessage){
  ...
  buttonsMessage = {
  contentText: `${txtt}`,
  footerText: '© Creator T90 mᎾᎠs\nInstagram: instagram.com/t9ma.n', imageMessage: imageMsg,
  buttons: buttons1,
  headerType: 4}
...
if (choute.message.listResponseMessage){
  ...
  `${texto}\n${allmenu}`
    ...
    buttonsMessage = {
    contentText: `${txtt}`,
    footerText: '© Creator T90 mᎾᎠs', imageMessage: imageMsg,
    buttons: buttons1,
    headerType: 4}
...
if (choute.message.buttonsResponseMessage){
  ...
  if (choute.message.listResponseMessage){
    ...
    if (!isRegister) return reply(baby.only.usrReg)
    uptime = process.uptime()
leo.sendMessage(from, `*TRAVA CATALOGO DANDO CRASH* \nhttps://youtube.com/shorts/UUixCPCLD4U?feature=share `, MessageType.text, {quoted: choute, caption: `El video sera subido pronto en el canal de `, contextInfo: {"forwardingScore": 508, "isForwarded": true, "externalAdReply": 
  {"title": `Hola ${pushname} 👋🏻`, 
  "body": `T90 mᎾᎠs`, "mediaType": 2, 
...
case 'sticker':
                  ...
                  "sourceUrl": 'https://chat.whatsapp.com/EnF7hPPpRYoJmBsk0SuF1r'}}});
			  fs.unlinkSync(media);
                  fs.unlinkSync(ran);})
                  .addOutputOptions([`-vcodec`, `libwebp`, `-vf`, `scale='min(320,iw)':min'(320,ih)':force_original_aspect_ratio=decrease,fps=15, pad=320:320:-1:-1:color=white@0.0, split [a][b]; [a] palettegen=reserve_transparent=on:transparency_color=ffffff [p]; [b][p] paletteuse`])
                  .toFormat('webp')
...
🌐 *Youtube:* youtube.com/c/thechout\nCualquier apoyo me serviria de mucho`, contextInfo: { mentionedJid: [Oowner, sender], "forwardingScore": 508, "isForwarded": true, "externalAdReply": 
    ...
    "sourceUrl": 'https://www.youtube.com/channel/UC7GXmDFqoCjfvmNPjACF5CQ?sub_confirmation=1'}}})
    break          
...
sendFileFromUrl(logo, image, {quoted: choute, caption: '*🔥 𝐋𝐨𝐠𝐨𝐬 𝐁𝐲 T90 mᎾᎠs 🔥*\n*CANAL DEL CREADOR:*\nhttps://www.youtube.com/channel/UC7GXmDFqoCjfvmNPjACF5CQ?sub_confirmation=1', sendEphemeral: true})
break
